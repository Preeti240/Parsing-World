...
function formatGrammar(grammar) {
	...
	if (typeof(Item) != 'undefined') {
		result += "<div align='center'><b> Analysis " + Item.prototype.grammarType + " - Enter the Grammar Production Set including increased grammar (e.g. E' -> E). <br> Empty sentence (&epsilon;) = '' </b></div><br>";
	}
	...
	result += "<br><div class='alert alert-info'><strong>Note:</strong> After entering the Production Set, the numbering of the productions is performed automatically.</div>";
