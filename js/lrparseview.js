...
function formatInitialParseView(input, maximumStepCount) {
	var result = "<p><b>Judgment to be recognized: </b><input class='form-control' id=\"input\" type=\"text\" size=\"" + input.length + "\" onkeyup=\"resize(this, 1);\" onchange=\"parseInput();\" value=\"" + input + "\"></p>";
	...
	result += "<input type=\"button\" class=\"btn btn-success btn-gerar btn-lg\" value=\"Acknowledge Entry\"><br><br>";
	result += "<br>";
	result += "<table class='table table-bordered'>";
	result += "<thead>";
	result += "<tr><th colspan=\"4\">Entry Recognition</th></tr>";
	result += "<tr><th>Step</th><th>Stack</th><th>Input Tape</th><th>Action</th></tr>";
	result += "</thead>";
